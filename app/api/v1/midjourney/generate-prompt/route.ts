...
const RAILWAY_AGENT_URL = process.env.RAILWAY_AGENT_URL || 'https://smallplatesweb-production.up.railway.app/generate-prompt';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const response = await fetch(RAILWAY_AGENT_URL, {
      method: 'POST',
      headers: {
