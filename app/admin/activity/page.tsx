...
export default function ActivityPage() {
  ...
  const loadGuests = async (userId: string) => {
    ...
    try {
      ...
      const response = await fetch(`/api/admin/activity/users/${userId}`);
  ...
  const loadRecipes = async (userId: string, guestId: string) => {
    ...
    try {
      ...
      const response = await fetch(`/api/admin/activity/users/${userId}/guests/${guestId}/recipes`);
          ...
          <div className="flex-1 bg-white overflow-y-auto">
            <div className="p-6">
              ...
              <div className="space-y-6">
                ...
                {/* Images Section - only show if there are uploaded images */}
                {selectedRecipe.document_urls && selectedRecipe.document_urls.length > 0 && (
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mb-3">Guest uploaded these images:</p>
