...
import RegalosUSASpecsGrid from "./RegalosUSASpecsGrid";
import RegalosUSADetailStrip from "./RegalosUSADetailStrip";
...
export default function RegalosUSATheBook() {
        ...
        >
          ...
          <div className="mt-10">
            <a
              ...
              onClick={() =>
                trackEvent("start_book_click", { cta_location: "regalos_usa_thebook_primary" })
              }
