...
export default function RegalosUSAHero() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src="/images/regalo-usa-landing/hero-regalos-usa.png"
      ...
      <div className="relative z-10 w-full px-6 md:px-12 lg:px-16 pt-28 md:pt-32 pb-16 md:pb-24">
        <div className="max-w-3xl">
          ...
          >
            Un recetario que trae a todos a la mesa.
          </motion.h1>
          <motion.p
          ...
          >
            ...
            <div className="flex flex-col items-center gap-2">
              <a
                ...
                onClick={() => trackEvent("start_book_click", { cta_location: "regalos_usa_hero_primary" })}
