...
const pillars = [
  ...
  },
  {
    ...
    title: "O escríbala en el teléfono.",
    body:
      "Si solo la tiene en la cabeza. Sin app, sin instalar nada. Le llega un link por WhatsApp y se escribe ahí mismo.",
  },
] as const;
...
export default function RegalosUSAEasyToUse() {
  return (
    <section
    ...
    >
      <div className="mx-auto max-w-6xl px-6 md:px-10">
        ...
        <motion.p
          ...
          transition={{ duration: 0.5, ease: easeOut }}
        >
          Si se atora, le contestamos por WhatsApp.
        </motion.p>
