...
import RegalosUSARecipeModal from "./RegalosUSARecipeModal";
...
export default function RegalosUSABooksPrinted() {
  ...
  const books = [
    // First set (original)
    {
      ...
      thumbnail: "/images/books_printed/recipe_thumb_1.png",
      fullSpread: "/images/books_printed/recipe_modal_1.png",
    },
    {
      id: 2,
      ...
      author: "Por Jerry",
      color: "bg-stone-200",
      thumbnail: "/images/books_printed/recipe_thumb_2.png",
      fullSpread: "/images/books_printed/recipe_modal_2.png",
    },
    {
      id: 3,
      ...
      color: "bg-slate-500",
      thumbnail: "/images/books_printed/recipe_thumb_3.png",
      fullSpread: "/images/books_printed/recipe_modal_3.png",
    },
    {
      id: 4,
      ...
      color: "bg-red-800",
      thumbnail: "/images/books_printed/recipe_thumb_4.png",
      fullSpread: "/images/books_printed/recipe_modal_4.png",
    },
    // Second set
    {
      id: 5,
      ...
      color: "bg-amber-700",
      thumbnail: "/images/books_printed/recipe_thumb_5.png",
      fullSpread: "/images/books_printed/recipe_modal_5.png",
    },
    {
      id: 6,
      ...
      color: "bg-indigo-600",
      thumbnail: "/images/books_printed/recipe_thumb_6.png",
      fullSpread: "/images/books_printed/recipe_modal_6.png",
    },
    {
      id: 7,
      ...
      color: "bg-rose-600",
      thumbnail: "/images/books_printed/recipe_thumb_7.png",
      fullSpread: "/images/books_printed/recipe_modal_7.png",
    },
    {
      id: 8,
      ...
      color: "bg-teal-700",
      thumbnail: "/images/books_printed/recipe_thumb_8.png",
      fullSpread: "/images/books_printed/recipe_modal_8.png",
    },
    // Third set
    {
      id: 9,
      ...
      color: "bg-purple-700",
      thumbnail: "/images/books_printed/recipe_thumb_9.png",
      fullSpread: "/images/books_printed/recipe_modal_9.png",
    },
    {
      id: 10,
      ...
      color: "bg-orange-700",
      thumbnail: "/images/books_printed/recipe_thumb_10.png",
      fullSpread: "/images/books_printed/recipe_modal_10.png",
    },
    {
      id: 11,
      ...
      color: "bg-green-700",
      thumbnail: "/images/books_printed/recipe_thumb_11.png",
      fullSpread: "/images/books_printed/recipe_modal_11.png",
    },
    {
      id: 12,
      ...
      color: "bg-blue-700",
      thumbnail: "/images/books_printed/recipe_thumb_12.png",
      fullSpread: "/images/books_printed/recipe_modal_12.png",
    },
  ];
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-12 md:mb-16">
          ...
          >
            <a
              ...
              onClick={() =>
                trackEvent("start_book_click", { cta_location: "regalos_usa_books_printed_proof" })
              }
