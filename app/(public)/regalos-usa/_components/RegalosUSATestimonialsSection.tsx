...
import { RegalosUSATestimonialCard, type Testimonial } from "./RegalosUSATestimonialCard";
...
export default function RegalosUSATestimonialsSection() {
    ...
    >
      <div className="mx-auto max-w-7xl px-6 md:px-8">
        ...
        >
          ...
          >
            {testimonials.map((t) => (
              <RegalosUSATestimonialCard key={t.id} t={t} />
            ))}
          </motion.div>
        </div>
