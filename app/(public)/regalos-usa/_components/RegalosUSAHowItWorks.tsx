...
const steps = [
  ...
  },
  {
    ...
    description:
      "En cinco minutos, desde el celular. La receta, una foto si quiere, una nota corta para los novios. Nosotros nos encargamos de revisarlas, ordenarlas y diseñarlas. Y cada receta lleva su propia foto, hecha por nosotros.",
...
export default function RegalosUSAHowItWorks() {
  return (
    <section
      id="how-it-works"
      ...
      <div className="mx-auto max-w-6xl px-6 md:px-10">
        ...
        <div className="mt-14 md:mt-20 flex justify-center">
          <a
            ...
            onClick={() =>
              trackEvent("start_book_click", { cta_location: "regalos_usa_howitworks_primary" })
            }
