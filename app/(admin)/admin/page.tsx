    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
          ...
          {/* QA Review */}
          <Link href="/admin/qa-review" className="group">
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-2xl transition-all duration-300 border-2 border-transparent group-hover:border-brand-honey cursor-pointer h-full">
              <div className="text-5xl mb-4">🔍</div>
              <h2 className="text-2xl font-bold text-gray-900 mb-2">QA Review</h2>
              <p className="text-gray-600 mb-4">
                Sube el PDF final y deja que el agente lo revise contra la DB
              </p>
              <div className="flex items-center text-sm text-gray-500 group-hover:text-brand-honey transition-colors">
                <span>Revisar PDF</span>
                <svg className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* Archivados */}
          <Link href="/admin/archivados" className="group">
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-2xl transition-all duration-300 border-2 border-transparent group-hover:border-black cursor-pointer h-full">
              <div className="text-5xl mb-4">🪦</div>
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Archivados</h2>
              <p className="text-gray-600 mb-4">
                Libros dados por muerto: escondidos de todo el admin, con su razón, para reactivar
              </p>
              <div className="flex items-center text-sm text-gray-500 group-hover:text-black transition-colors">
          ...
          <Link href="/admin/content" className="group">
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-2xl transition-all duration-300 border-2 border-transparent group-hover:border-black cursor-pointer h-full">
              ...
              <p className="text-gray-600 mb-4">
                Add and edit recipes on behalf of guests
              </p>
              <div className="flex items-center text-sm text-gray-500 group-hover:text-black transition-colors">
          ...
          {/* Email Dashboard */}
          <Link href="/admin/email-dashboard" className="group">
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-2xl transition-all duration-300 border-2 border-transparent group-hover:border-brand-honey cursor-pointer h-full">
              <div className="text-5xl mb-4">✉️</div>
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Email Dashboard</h2>
              <p className="text-gray-600 mb-4">
                Captain reminders, weekly status, pre-closing nudges
              </p>
              <div className="flex items-center text-sm text-gray-500 group-hover:text-brand-honey transition-colors">
          ...
          {/* Debug Logs */}
          <Link href="/admin/debug-logs" className="group">
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-2xl transition-all duration-300 border-2 border-transparent group-hover:border-black cursor-pointer h-full">
              <div className="text-5xl mb-4">🐛</div>
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Debug Logs</h2>
              <p className="text-gray-600 mb-4">
                Review system errors and missing data issues
              </p>
              <div className="flex items-center text-sm text-gray-500 group-hover:text-black transition-colors">
                <span>View logs</span>
                <svg className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
