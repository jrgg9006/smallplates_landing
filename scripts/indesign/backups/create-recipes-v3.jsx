...
function main() {
    ...
    if (doc.spreads.length < 3) {
        alert("Error: Se necesitan al menos 3 spreads template en el documento.\n\n" +
    ...
    var templateA = doc.spreads[0];
    var templateB = doc.spreads[1];
    var templateC = doc.spreads[2];
