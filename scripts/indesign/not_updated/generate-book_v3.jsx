...
function main() {
    ...
    if (!confirm("SMALL PLATES - Book Generator v1.3\n\n" +
                 ...
                 "NOTA: Recetas + fillers se generan AL FINAL.\n" +
                 "Las paginas fijas NO se mueven.\n\n" +
                 "Generar?")) {
        return;
    }
    ...
    for (var i = 0; i < recipes.length; i++) {
        try {
            ...
            if (fillerPositions[recipeNum]) {
                fillerPositions[recipeNum].duplicate(LocationOptions.AT_END);
                stats.fillers++;
    ...
    // ── STEP 8: Delete original templates ──
    $.writeln("\n=== Removing templates ===");
    ...
    msg += "\nNOTA: Recetas estan AL FINAL del documento.";
    msg += "\nLas paginas fijas estan en su posicion original.";
