...
// TO RUN: node scripts/indesign/fetch-book_v2.js
//
// v2: añade couple.occasion al JSON para que generate-book_v17.jsx
//     decida el contenido de las páginas 3 y 11 según la ocasión.
//     (copia de fetch-book.js — el original queda intacto)
