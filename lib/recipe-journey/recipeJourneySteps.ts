export type JourneyStepKey = 'welcome' | 'recipeType' | 'introInfo' | 'realBook' | 'uploadMethod' | 'recipeForm' | 'recipeTitle' | 'imageUpload' | 'personalNote' | 'signature' | 'summary' | 'success';
...
export const journeySteps: JourneyStepConfig[] = [
  ...
  { key: 'signature', title: 'Signature', ctaLabel: 'Continue' },
