...
export function CaptainsDropdown({ isOpen, selectedGroup, onClose, onInviteCaptain, refreshTrigger, align = "right" }: CaptainsDropdownProps) {
  ...
  return (
    <>
      ...
      {/* Dropdown */}
      <div className={`absolute top-full ${align === "left" ? "left-0" : "right-0"} mt-2 bg-[hsl(var(--brand-white))] rounded-2xl shadow-[0_4px_24px_rgba(45,45,45,0.12)] p-3 min-w-[220px] z-50 border border-[hsl(var(--brand-border))]`}>
