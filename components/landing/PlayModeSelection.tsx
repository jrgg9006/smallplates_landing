...
export default function PlayModeSelection() {
  const playModeContent = [
    {
      number: "01",
      title: "Make it just yours",
      description: "Gather recipes from your people and make something that's entirely yours.",
    ...
    },
    {
      ...
      description: "Invite your people to contribute and everyone gets their own copy.",
      ...
      <div className="mx-auto max-w-7xl px-6 md:px-8">
        ...
        >
          ...
          <p className="text-base md:text-lg text-gray-600 font-light leading-relaxed max-w-xl mx-auto">
            Whether you want to make it solo or bring people together, it&apos;s simple either way
          </p>
        </motion.div>
