...
const PHONE = process.env.NEXT_PUBLIC_WHATSAPP_NUMBER ?? "526142256589";
const MESSAGE = encodeURIComponent("Hi, I have a question about Small Plates & Co.");
const WA_URL = `https://wa.me/${PHONE}?text=${MESSAGE}`;
const SESSION_KEY = "sp_wa_bubble_seen";
