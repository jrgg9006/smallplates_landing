    ...
    >
      ...
      <div className="relative z-10 w-full px-6 md:px-12 lg:px-16 pt-28 md:pt-32 pb-16 md:pb-24">
        <div className="max-w-4xl">
          ...
          >
            Where food becomes the reason to gather 
          </motion.h1>
          <motion.p 
            className="font-sans mt-4 text-xl sm:text-2xl md:text-3xl font-light text-white/90 max-w-prose drop-shadow"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.5, ease: "easeOut" }}
          >
            A book made from the plates your friends actually cook.
          </motion.p>
          <motion.div 
          ...
          >
            ...
            <motion.button
              ...
              className="mt-2 pl-2 text-base md:text-lg font-sans font-normal text-white/90 hover:text-white underline underline-offset-2 transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-transparent rounded"
