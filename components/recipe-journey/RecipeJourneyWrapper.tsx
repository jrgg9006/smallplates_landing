      ...
      {current === 'success' ? (
        <>
          <button
            ...
            className="px-4 py-2.5 sm:px-6 sm:py-3 rounded-full bg-brand-honey text-white hover:bg-[#c49b4a] text-sm sm:text-base"
          >
        ...
        <button
          ...
          className="px-8 py-3 rounded-full bg-brand-honey text-white hover:bg-[#c49b4a] disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {current === 'imageUpload'
