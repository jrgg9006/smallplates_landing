...
// so the old 5MB cap rejected perfectly normal uploads mid-journey. We keep the
// original file untouched (it feeds the printed Originals section) and only guard
// against pathological sizes. The `recipes` bucket has no per-file limit, so the
// ceiling is the project-wide 50MB.
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
                ...
                >
                  <div className="flex flex-col items-center space-y-4">
                    ...
                    <div className="text-center">
                      <h3 className="font-medium text-lg text-brand-charcoal">Take a photo</h3>
