  ...
  return (
    <article
      className="
        ...
        prose-headings:font-serif prose-headings:text-[#2D2D2D] prose-headings:font-medium
        ...
        prose-p:text-[#2D2D2D]/80 prose-p:leading-[1.8] prose-p:font-sans prose-p:text-[15px]
        prose-li:text-[#2D2D2D]/80 prose-li:leading-[1.8] prose-li:font-sans prose-li:text-[15px]
